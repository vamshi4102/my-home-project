...
export const featuresData = [
  {
    ...
    pageUrl: "/products",
    shortDescription:
      "Explore a wide range of high-quality building materials and supplies from trusted vendors.",
  },
  {
    title: "Workers",
    pageUrl: "/workers",
    shortDescription:
      "Find skilled construction workers and professionals to bring your home-building project to life.",
  },
  {
    title: "Builders",
    pageUrl: "/builders",
    shortDescription:
      "Connect with experienced builders and contractors for expert construction services and project management.",
  },
];

export const brandData = {
  brandName: "MYHOME",
  caption: "Building Dreams, One Home at a Time",
  description:
    "MYHOME is your all-in-one platform connecting trusted vendors, skilled workers, and homeowners to simplify and empower the entire house construction journey.",
  copyright: "© 2025 MYHOME. All rights reserved.",
};
